...
This document provides the current, repository-ready steps required to run CareerGenie locally.
...
## 7. Notes
- The core product can run locally without the heavier AI interview services.
- The full AI interview workflow may require additional model files in backend-ai/models and backend-ai/weights.
- If CV features fail, confirm that the CV service is running on port 8002 and that frontend/.env points to it.
