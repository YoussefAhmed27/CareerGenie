...
const Login: React.FC = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            // STEP A: Fetch the Secret CSRF Token
            ...
            // STEP D: Auto-Login if registering, or Save Token if logging in
            if (!isLoginMode) {
            ...
            // STEP E: Routing
            const isHrAccount = role === "hr" || email.toLowerCase().includes("hr");
            if (isHrAccount) {
                navigate("/hr-dashboard");
            } else {
                navigate("/"); // Back to the Logged-In Home Page!
            }
